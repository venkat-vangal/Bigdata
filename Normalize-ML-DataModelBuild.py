"""
1. Import statements for libraries and your data set
2. Functions to normalize and split the data set
3. Choice of classifier with parameters
4. Output of your predicted and actual values
5. Comments explaining the code blocks. 
"""
